...
**Python → Data → KPIs → Analysis → Insights → Recommendations → Action**
...
| 06 | **Insights** | Executive intelligence, risks & recommendations |
...
<p align="center">
  <img src="Images/insights.png" alt="PGIP AI Insights" width="100%">
</p>
...
- Unified navigation and insight panels
...
PGIP uses a synthetically generated multi-domain dataset designed to simulate a realistic digital product and e-commerce analytics environment.

Python was used to generate structured data covering:

- Customers and user attributes
- Products and categories
- Orders, revenue, profit, quantity, and transactions
- Sessions, visitors, and engagement activity
- User events and behavioral activity

The generated data was then prepared for analytical modeling and used in the downstream SQL and Power BI workflow.

### Data Generation & Analytics Pipeline

**Python → Synthetic Data → SQL/PostgreSQL → Power Query → Power BI → DAX → Executive Insights**
...
- Automated insight and recommendation panels
...
| **Pandas** | Data manipulation, analytical processing, KPI analysis, and rule-based insight generation |
